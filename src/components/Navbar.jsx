                    ...
                    <div className="absolute right-0 mt-2 w-64 rounded-xl backdrop-blur-xl bg-black/90 border border-white/20 shadow-2xl overflow-hidden z-50">
                      ...
                      <div className="py-2">
                        ...
                        <button
                          ...
                          className="flex items-center w-full px-4 py-2 text-white/90 hover:text-white hover:bg-white/10 transition-colors"
                        >
                          <IconComponent type="settings" className="w-4 h-4 mr-3" />
                          Settings
                        </button>
                <button 
